						...
						<view class="weui-cell weui-cell_access">
							...
							<view class="weui-cell__bd">
								...
								<view class="od-info">
									...
									<!-- 按钮部分 -->
									<view class="selected">
										<text class="cancel" @click="onCancel(item.id, item.trade_state)">取消</text>
										<text class="delete" @click="onDelete(item.id, item.trade_state)">删除</text>
									</view>
...
<style>
	...
	.selected {
	    display: flex;
	    flex-direction: column; /* 按钮上下分布 */
	    position: absolute;
	    right: 10px; /* 距离右侧10px */
	    top: 50%; /* 垂直居中 */
	    transform: translateY(-50%); /* 偏移自身高度一半实现居中 */
	}
