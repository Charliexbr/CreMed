class Utils {
	constructor() {
		...
		//this.message_baseUrl = 'http://172.16.67.136:8899/pz'
		//this.message_baseUrl = 'https://code.itndedu.com/pz'
		//this.message_baseUrl = 'http://dzb.com:8899'
		//this.message_baseUrl = 'http://172.16.67.129:8899'
		this.message_baseUrl = 'http://192.168.248.5:8811'
	}
	...
	*/
	...
	request2(options = {
		...
		uni.request({
			url: this.message_baseUrl + options.url, // 请求地址
			method: options.method ? options.method : 'GET', // 请求方式
			data: options.data ? options.data : {}, // 请求参数
			header: options.header ? options.header : {}, // 请求头
			success: (response) => {
